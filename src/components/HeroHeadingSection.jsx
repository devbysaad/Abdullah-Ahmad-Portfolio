...
export default function HeroHeadingSection({ about, site }) {
    ...
    >
      ...
      <div className="content-wrap hero-body">
        ...
        <div className="hero-main-grid">
          ...
          >
            <p className="hero-greeting">{hero.greeting || 'Hi, there'}</p>
        ...
        >
          {[
            { value: stats.years || '4+', label: 'Years in Engineering' },
            { value: stats.clients || '20+', label: 'Satisfied Clients' },
            { value: stats.apps || '12+', label: 'Apps Shipped' },
