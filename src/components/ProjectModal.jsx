      ...
      {project && (
        <>
          ...
          >
            ...
            {resolveMediaUrl(project.imageUrl) && (
              <div className="rounded-xl overflow-hidden mb-6 aspect-video">
                <img src={resolveMediaUrl(project.imageUrl)} alt={project.name} className="w-full h-full object-cover" loading="lazy" decoding="async" />
              </div>
            )}
